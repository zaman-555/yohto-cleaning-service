  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "focus-visible:ring-2 focus-visible:ring-emerald-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-900",
        "disabled:cursor-not-allowed disabled:opacity-60",
        "data-[state=checked]:bg-emerald-500 data-[state=unchecked]:bg-neutral-600",
        className
      )}
      {...props}
    >
